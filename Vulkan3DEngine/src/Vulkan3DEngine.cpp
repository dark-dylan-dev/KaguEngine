...
void Vulkan3DEngine::createCommandBuffer() {
...
bool Vulkan3DEngine::checkValidationLayerSupport() {
    uint32_t layerCount;
...
SwapChainSupportDetails Vulkan3DEngine::querySwapChainSupport(VkPhysicalDevice device) {
...
VkSurfaceFormatKHR Vulkan3DEngine::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR Vulkan3DEngine::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D Vulkan3DEngine::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
VkResult Vulkan3DEngine::CreateDebugUtilsMessengerEXT(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) {
...
VKAPI_ATTR VkBool32 VKAPI_CALL Vulkan3DEngine::debugCallback(
...
void Vulkan3DEngine::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo) {
    createInfo = {};
...
void Vulkan3DEngine::DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugMessenger, const VkAllocationCallbacks* pAllocator) {
