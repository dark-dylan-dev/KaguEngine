...
void KaguEngine::App::createDescriptorSetLayout() {
...
void KaguEngine::App::createGraphicsPipeline() {
    ...
    rasterizer.cullMode = VK_CULL_MODE_NONE;            // VK_CULL_MODE_BACK_BIT to disable backfaces ...MODE_NONE else
    rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE; // VK_FRONT_FACE_CLOCKWISE else
...
VkFormat KaguEngine::App::findSupportedFormat(const std::vector<VkFormat>& candidates, const VkImageTiling tiling, const VkFormatFeatureFlags features) const {
...
VkFormat KaguEngine::App::findDepthFormat() const {
...
void KaguEngine::App::createColorResources() {
...
void KaguEngine::App::createDepthResources() {
...
void KaguEngine::App::createBuffer(
...
void KaguEngine::App::copyBuffer(const VkBuffer srcBuffer, const VkBuffer dstBuffer, const VkDeviceSize size) const {
...
void KaguEngine::App::createIndexBuffer() {
...
void KaguEngine::App::createUniformBuffers() {
...
void KaguEngine::App::createDescriptorSets() {
...
void KaguEngine::App::createSyncObjects() {
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++) {
        if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphores[i]) != VK_SUCCESS ||
            ...
            throw std::runtime_error("Failed to create synchronization models for a frame!");
        }
    }
}