...
void KaguEngine::App::createGraphicsPipeline() {
    ...
    rasterizer.cullMode = VK_CULL_MODE_NONE;       // Deactivated the face culling - could be changed later
    //rasterizer.cullMode = VK_CULL_MODE_BACK_BIT; // To ignore the backfaces
