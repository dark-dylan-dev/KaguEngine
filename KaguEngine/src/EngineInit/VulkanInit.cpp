...
void KaguEngine::App::createGraphicsPipeline() {
    ...
    rasterizer.cullMode = VK_CULL_MODE_BACK_BIT;            // Ignores the backfaces
    rasterizer.frontFace = VK_FRONT_FACE_COUNTER_CLOCKWISE;
    //rasterizer.cullMode = VK_CULL_MODE_NONE;              // Deactivates the face culling - could be changed later
...
VkFormat KaguEngine::App::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
...
VkFormat KaguEngine::App::findDepthFormat() {
