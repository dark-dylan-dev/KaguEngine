...
// GLM hash implementation for the KaguEngine::Vertex struct
template<> struct std::hash<KaguEngine::Vertex> {
	size_t operator()(const KaguEngine::Vertex & vertex) const noexcept {
